...
{ /* check class */
  if (class != 'S' && 
    ...
    printf("setparams: Allowed classes are \"S\", \"W\", \"T\",  and \"A\" through \"E\"\n");
    exit(1);
  }
...
void write_sp_info(FILE *fp, char class) 
{
  ...
  else if (class == 'T') { problem_size = 4;  dt = "0.015";   niter = 5; }
...
void write_bt_info(FILE *fp, char class) 
{
  ...
  else if (class == 'T') { problem_size = 4;  dt = "0.010";   niter = 5; }
...
void write_dc_info(FILE *fp, char class) 
{
  ...
  else if (class == 'T') { input_tuples = 10;     attrnum = 5; }
...
void write_lu_info(FILE *fp, char class) 
{
  ...
  else if (class == 'T') { problem_size = 5;  dt_default = "0.5"; itmax = 5; }
...
void write_mg_info(FILE *fp, char class) 
{
  ...
  else if (class == 'T') { problem_size = 8; nit = 4; }
...
void write_cg_info(FILE *fp, char class) 
{
  ...
  { na=100; nonzer=3; niter=5; shift=shiftS; }
  else if( class == 'W' )
...
void write_ua_info(FILE *fp, char class) 
{
  ...
  { lelt=10;lmor=100;       refine_max=4;  niter=5;  nmxh=10; alpha="0.040e0"; }
  else if( class == 'W' )
...
void write_ft_info(FILE *fp, char class) 
{
  ...
  else if (class == 'T') { nx = 8; ny = 8; nz = 8; niter = 5;}
